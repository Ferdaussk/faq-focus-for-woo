...
// For woocommerce
function qaffw_WooCommerce_register_required_plugins() {
	...
	if (qaffw_WooCommerce_addon_install()){
		...
		$bwd_w_plugin_the_notice_is = '<p><b>'.esc_html__('FAQ Focus for Woo').'</b> '.esc_html__('requires WooCommerce to be activated.').'</p>';
		...
		$bwd_w_plugin_the_notice_is = '<p><b>'.esc_html__('FAQ Focus for Woo').'</b> '.esc_html__('requires WooCommerce to be installed and activated.').'</p>';
...
function qaffw_WooCommerce_addon_install(){
